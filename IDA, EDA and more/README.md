# 🚨 CFPB CONSUMER COMPLAINTS: AN EXPLORATORY DATA ANALYSIS 🚨
An analysis of customer complaints to identify trends in company response, timeliness of responses, and overall consumer satisfaction.
### ℹ️ PROBLEM CONTEXT
Customers face challenges navigating the financial sector and its associated products. Financial companies provide a lack of clear communication relating to various customer complaints, such as hidden fees, for example, with opening new accounts or credit cards. 
Customers therefore lose trust in them, leading to unexpected situations and recurring problems and ultimately frustration.
### PROJECT OBJECTIVES 🎯
...
### 🔍 Data Cleaning
1. Removal of corrupted numeric columns
...
1. Complaint distribution across years
2. Top products generating complaints
3. Company-level complaint intensity
4. State-level complaint patterns
5. Dispute vs response analysis

### 🔥 Insights
### 📈 Visualizations Included
1. Line chart: Complaints per year
2. Bar chart: Top 10 companies
3. Heatmap: Timely response vs dispute
4. Product breakdown plots
5. State complaint intensity charts
